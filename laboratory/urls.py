...
urlpatterns = [
                  ...
                  url(r'^dashboard/', include('mainmenu.urls')),
                  url(r'^mainmenu/', include('mainmenu.urls')),
                  url(r'^mainmenu/receive$', receive),
                  url(r'^mainmenu/receive/one_by_one$', receive_obo),
                  url(r'^mainmenu/receive/last_received$', last_received),
                  url(r'^mainmenu/receive/execlist$', receive_execlist),
                  url(r'^mainmenu/receive/history$', receive_history),
                  url(r'^mainmenu/receive/journal$', receive_journal),
