                ...
                <div>
                  ...
                  <label>
                    ...
                    <select v-model.number="row.field_type" class="form-control">
                      ...
                      <option value="31">МКБ-внешние причины заболеваемости и смертности(1.2.643.5.1.13.13.99.2.692)</option>
                      <option value="32">МКБ-Алфавитный (1.2.643.5.1.13.13.11.1489)</option>
