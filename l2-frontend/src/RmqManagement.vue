<template>
  <div>
    ...
    <div>
      Отправить в задание на синхронизацию: с <input v-model="from" type="number" min="0"
                                                     :disabled="model === '' || insend"/>
      по <input v-model="to" :disabled="model === '' || insend" type="number" min="0"/>
