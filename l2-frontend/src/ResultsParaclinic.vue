        ...
        <div class="row">
          ...
          <div class="col-xs-5">
            ...
            <div>Карта: {{data.patient.card}}
              ...
              <div id="template-anamnesis" :class="{hidden: !data.ok || !data.has_doc_referral || !data.card_internal}">
              ...
              <div id="template-dreg" :class="{hidden: !data.ok || !data.has_doc_referral || !data.card_internal}">
