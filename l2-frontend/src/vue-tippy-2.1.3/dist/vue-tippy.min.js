 ...
 */
!(function (t, e) { typeof exports === 'object' && typeof module === 'object' ? module.exports = e() : typeof define === 'function' && define.amd ? define([], e) : typeof exports === 'object' ? exports.VueTippy = e() : t.VueTippy = e(); }(this, () => (function (t) { function e(n) { if (r[n]) return r[n].exports; const i = r[n] = { i: n, l: !1, exports: {} }; return t[n].call(i.exports, i, i.exports, e), i.l = !0, i.exports; } var r = {}; return e.m = t, e.c = r, e.i = function (t) { return t; }, e.d = function (t, r, n) { e.o(t, r) || Object.defineProperty(t, r, { configurable: !1, enumerable: !0, get: n }); }, e.n = function (t) { const r = t && t.__esModule ? function () { return t.default; } : function () { return t; }; return e.d(r, 'a', r), r; }, e.o = function (t, e) { return Object.prototype.hasOwnProperty.call(t, e); }, e.p = '', e(e.s = 3); }([function (t, e, r) {
  Object.defineProperty(e, '__esModule', { value: !0 }), r(4); const n = {
    install(t, e) {
      function r(r, n, i) {
        const o = i.data && i.data.on || i.componentOptions && i.componentOptions.listeners; let a = n.value || {}; if (a = {
          dynamicTitle: !0, reactive: !1, showOnLoad: !1, ...e, ...a,
        }, o && o.show && (a.onShow = function () { o.show.fns(r, i); }), o && o.shown && (a.onShown = function () { o.shown.fns(r, i); }), o && o.hidden && (a.onHidden = function () { o.hidden.fns(r, i); }), o && o.hide && (a.onHide = function () { o.hide.fns(r, i); }), a.html) { const p = a.html; if (a.reactive || typeof p !== 'string')a.html = p instanceof Element ? p : p instanceof t ? p.$el : document.querySelector(p); else { const s = document.querySelector(a.html); if (!s) return void console.error(`[VueTippy] Selector ${a.html} not found`); s._tipppyReferences ? s._tipppyReferences.push(r) : s._tipppyReferences = [r]; } } if ((a.html || r.getAttribute('data-tippy-html')) && (a.dynamicTitle = !1), r.getAttribute('data-tippy-html')) { const l = document.querySelector(r.getAttribute('data-tippy-html')); if (!l) return void console.error(`[VueTippy] Selector '${r.getAttribute('data-tippy-html')}' not found`, r); l._tipppyReferences ? l._tipppyReferences.push(r) : l._tipppyReferences = [r]; } new Tippy(r, a), a.showOnLoad && r._tippy.show(), t.nextTick(() => { o && o.init && o.init.fns(r._tippy, r); });
      }t.directive('tippy-html', { componentUpdated(e) { const r = e._tipppyReferences; r && r.length > 0 && t.nextTick(() => { r.forEach((t) => { if (t._tippy) { t._tippy.popper.querySelector('.tippy-content').innerHTML = e.innerHTML; } }); }); }, unbind(t) { delete t._tipppyReference; } }), t.directive('tippy', { inserted(e, n, i) { t.nextTick(() => { r(e, n, i); }); }, unbind(t) { t._tippy && t._tippy.destroy(); }, componentUpdated(e, n, i) { const o = n.value || {}; const a = n.oldValue || {}; e._tippy && JSON.stringify(o) !== JSON.stringify(a) && t.nextTick(() => { r(e, n, i); }), e._tippy && e._tippy.popperInstance && o.show ? e._tippy.show() : e._tippy && e._tippy.popperInstance && !o.show && o.trigger === 'manual' && e._tippy.hide(); } }), t.component('tippy', {
        render(t) { return t('div', this.$slots.default); },
        props: {
          to: { type: String, required: !0 }, placement: { type: String, default: 'top' }, theme: { type: String, default: 'light' }, interactive: { type: [Boolean, String], default: !1 }, arrow: { type: [Boolean, String], default: !1 }, arrowType: { type: String, default: 'sharp' }, arrowTransform: { type: String, default: '' }, trigger: { type: String, default: 'mouseenter focus' }, interactiveBorder: { type: Number, default: 2 }, animation: { type: String, default: 'shift-away' }, animationFill: { type: [Boolean, String], default: !0 }, distance: { type: Number, default: 10 }, delay: { type: [Number, Array], default() { return [0, 20]; } }, duration: { type: [Number, Array], default() { return [325, 275]; } }, offset: { type: Number, default: 0 }, followCursor: { type: [Boolean, String], default: !1 }, sticky: { type: [Boolean, String], default: !1 }, size: { type: String, default: 'regular' }, watchProps: { type: [Boolean, String], default: !1 }, popperOptions: { default: {} },
        },
        watch: { $props: { deep: !0, handler(t, e) { const n = this; document.querySelectorAll(`[name=${this.to}]`).forEach((t) => { if (n.watchProps) { t._tippy && t._tippy.destroy(); r(t, { value: { reactive: !0, html: n.$el, ...n.$props } }, n.$vnode); } }); } } },
        mounted() { const t = this; document.querySelectorAll(`[name=${this.to}]`).forEach((e) => { r(e, { value: { reactive: !0, html: t.$el, ...t.$props } }, t.$vnode); }); },
      });
    },
  }; typeof window !== 'undefined' && window.Vue && window.Vue.use(n), e.default = n;
}, function (t, e, r) { let n = r(5); typeof n === 'string' && (n = [[t.i, n, '']]); const i = {}; i.transform = void 0; r(7)(n, i); n.locals && (t.exports = n.locals); }, function (t, e, r) {
  (function (e) { /*!
* Tippy.js v2.6.0
* (c) 2017-2018 atomiks
* MIT
