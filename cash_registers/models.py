...
class Cheque(models.Model):
    ...
    cancelled = models.BooleanField(verbose_name='Статус', default=False)
    ...
    payment_electronic = models.DecimalField(max_digits=10, null=True, blank=True, default=None, decimal_places=2)
