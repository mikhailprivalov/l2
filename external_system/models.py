...
class FsliRefbookTest(models.Model):
    ...
    title = models.CharField(max_length=1000, help_text='Полное наименование')
    ...
    method_type = models.CharField(max_length=100, help_text='Тип метода')
    scale_type = models.CharField(max_length=100, help_text='Тип шкалы измерения')
    actual = models.BooleanField(default=True, help_text='Статус')
