...
from directory.models import Researches, Unit, LaboratoryMaterial, SubGroupDirectory, ResultVariants, MaterialVariants, SubGroupPadrazdeleniye, SubGroupDirectory
