    ...
    with connection.cursor() as cursor:
        cursor.execute(
            ...
            SELECT
                ...
                END
                AND CASE WHEN %(date_examination_start)s != '1900-01-01 00:00:00' THEN 
                ...
                END
                AND CASE WHEN %(date_recieve_start)s != '1900-01-01 00:00:00' THEN directions_napravleniya.time_gistology_receive AT TIME ZONE %(tz)s BETWEEN %(date_recieve_start)s AND %(date_recieve_end)s
