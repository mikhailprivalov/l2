constructor_help_message = [
    ...
    {"label": "-", "param": "%parent_dir_data", "value": "Для экспертизы. Сохранить данные из протокола, для к-рого проводится Экспертиза "
       "(Пациент-ФИО}. Д/р}. Полис. СНИЛС. Проткол. Номер"},
    ...
    {"label": "-", "param": "%months_ago#5#12121", "value": "Последнее значение поля за предыдущие 5 месяце"},
