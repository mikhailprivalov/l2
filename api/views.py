                    ...
                    for key in results:
                        ...
                        if ok:
                            for fraction_rel in q:
                                ...
                                slog.Log(key=json.dumps({"direction": [x.pk for x in direction], "issled_pk": issled.pk, "issled_title": issled.research.title}), type=22, body=json.dumps(save_state), user=None).save()
                        oks.append(ok)
