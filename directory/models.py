...
class Researches(models.Model):
    ...
    RESULT_FORMS = (
        ...
        (10701, "107.01 - МСЭ"),
        (10801, "108.01 - 83-МПР"),
        (10802, "108.02 - Направление на ВИЧ"),
        (10803, "108.03 - Направлениена ХТИ"),
        (10804, "108.04 - Справка о доставке биообъектов на ХТИ"),
        (10901, "109.01 - 131/у"),
        ...
        (11301, "113.01 - Медзаключение"),
        (12001, "120.01 - Форма параклиники с логотипом"),
    )
    ...
    schedule_title = models.CharField(max_length=255, default="", null=True, blank=True, help_text="Название для расписания", db_index=True)
    ...
    oid_title = models.CharField(max_length=255, default="", null=True, blank=True, db_index=True, help_text="oid-название документа 1.2.643.5.1.13.13.11.1520")
...
class ParaclinicInputField(models.Model):
    ...
    required_set_by_admin = models.BooleanField(default=False, blank=True)
    ...
    attached = models.CharField(max_length=128, help_text="Скреплено с полем другой услуги", blank=True, default=None, null=True, db_index=True)
...
class Fractions(models.Model):
    ...
    ecp_id_synonym = models.CharField(max_length=160, default="", blank=True, verbose_name="Код теста в ЕЦП синоним")
