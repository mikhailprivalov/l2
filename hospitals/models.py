...
class Hospitals(models.Model):
    ...
    kpp = models.CharField(max_length=9, blank=True, default='', help_text=" КПП больницы")
    ...
    smtp_address = models.CharField(max_length=100, blank=True, null=True, default="Asia/Irkutsk", help_text="SMTP=address")
    smtp_login = models.CharField(max_length=100, blank=True, null=True, default="Asia/Irkutsk", help_text="SMTP_login")
    smtp_password = models.CharField(max_length=100, blank=True, null=True, default="Asia/Irkutsk", help_text="SMTP_pass")
    smtp_port= models.CharField(max_length=100, blank=True, null=True, default="Asia/Irkutsk", help_text="SMTP_port")
