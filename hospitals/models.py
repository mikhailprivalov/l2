...
class Hospitals(models.Model):
    ...
    only_services_with_hospital_synonym = models.BooleanField(default=False, blank=True, db_index=True, help_text='Создание заявки: показывать только услуги с синонимом')
