    ...
    with connection.cursor() as cursor:
        cursor.execute(
            """
                ...
                SELECT DISTINCT ON (t_iss.year_date, t_iss.research_id) t_iss.year_date, t_iss.month_date, t_iss.day_date, t_iss.iss_id, t_iss.card_id, t_iss.dir_id, t_iss.research_id, t_iss.confirm
                From t_iss
