...
class Card(models.Model):
    ...
    main_address = models.CharField(max_length=255, blank=True, default='', help_text="Адрес регистрации")
    main_address_fias = models.CharField(max_length=255, blank=True, default=None, null=True, help_text="ФИАС Адрес регистрации")
    main_address_details = JSONField(blank=True, null=True, help_text="Детали адреса регистрации")
    fact_address = models.CharField(max_length=255, blank=True, default='', help_text="Адрес факт. проживания")
    fact_address_fias = models.CharField(max_length=255, blank=True, default=None, null=True, help_text="ФИАС Адрес факт. проживания")
