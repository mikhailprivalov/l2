...
def dashboard(request):  # Представление панели управления
    if not request.is_ajax():
        ...
        pages = [
            ...
            {"url": "/dashboard/change_password", "title": "Настройка профилей пользователей", "nt": False, "access": ["Создание и редактирование пользователей"]},
            {"url": "/dashboard/create_podr", "title": "Управление подразделениями", "nt": False, "access": ["Создание и редактирование пользователей"]},
...
def change_password(request):
    ...
    if request.is_ajax():
        ...
        return HttpResponse(json.dumps({"groups": groups, "fio": doc.fio}), content_type="application/json")
    otds = {}
