...
class Podrazdeleniya(models.Model):  # Модель подразделений
    ...
    hosp_research_default = models.ForeignKey('directory.Researches', blank=True, default=None, null=True, verbose_name="Услуга стационара по котрой по умолчанию подгружаются шаблоны", on_delete=models.CASCADE)
