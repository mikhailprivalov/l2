...
def get_doctor_ecp_free_slots_by_date(rmis_location, date):
    ...
    if "@R" in rmis_location:
        ...
        req_result = make_request_get("TimeTableResource/TimeTableResourceFreeDateTime", query=f"Sess_id={sess_id}&Resource_id={rmis_location_resource}&TimeTableResource_beg={date}", sess_id=sess_id)
    else:
        key_time = "TimeTableGraf_begTime"
...
def register_patient_ecp_slot(patient_ecp_id, slot_id, slot_type):
    ...
    if slot_type == "TimeTableGraf_id":
        ...
        req_result = make_request_get("TimeTableResource/TimeTableResourceWrite", query=f"Sess_id={sess_id}&Person_id={patient_ecp_id}&TimeTableResource_id={slot_id}", sess_id=sess_id, method="POST")
    if req_result:
...
def get_ecp_evn_direction(patient_ecp_id):
    ...
    req_result = make_request_get("EvnDirection", query=f"Sess_id={sess_id}&Person_id={patient_ecp_id}&EvnDirection_beg={start_date}&EvnDirection_end={end_date}&DirType_id=10", sess_id=sess_id)
