        ...
        with open(fp) as json_file:
            ...
            for group in data["culture_group"]:
                ...
                for culture in group["culture_in_group"]:
                    culture_in_group = Culture(title=culture["title"], group_culture=culture_group.pk, fsli=culture["fsli"], lis=culture["lis"])
            ...
            for group in data["antibiotic_group"]:
                ...
                for antibiotic in group["antibiotic_in_group"]:
                    antibiotic_in_group = Antibiotic(title=antibiotic["title"], group_antibiotic=antibiotic_group.pk, fsli=antibiotic["fsli"], lis=antibiotic["lis"])
