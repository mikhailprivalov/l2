...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        """
        :param path - xlsx файл со Специальностями со столбцами:
        ...
        for row in ws.rows:
            ...
            if not starts:
                ...
                r = Speciality.objects.filter(n3_id=cells[code_nsi])
                if not r.exists():
                    Speciality(n3_id=cells[code_nsi], title=cells[title]).save()
