...
class DoctorProfile(models.Model):
    ...
    height_stamp_jpg = models.PositiveSmallIntegerField(blank=True, null=True, default=0, help_text="Высота штампа 50")
    width_stamp_jpg = models.PositiveSmallIntegerField(blank=True, null=True, default=0, help_text="Ширина штампа 200")
    ...
    stationar_additional_info = models.TextField(default='', blank=True, help_text='Дополнительная информация для СТАЦИОНАРА описывать словарем {}')
    ...
    def get_eds_allowed_sign(self):
        ret = []
        doc_groups = ("Врач-диагностики", "Врач параклиники", "Врач консультаций", 'Врач-лаборант')
