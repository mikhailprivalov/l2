...
class PlanExamination(models.Model):
    ...
    type_examinations = models.SmallIntegerField(default=-1, choices=TYPES, blank=True, help_text='Вид планирвоания')
    patient_card = models.ForeignKey(Clients.Card, null=True, help_text='Карта пациента', db_index=True, on_delete=models.SET_NULL)
    patient_fio = models.CharField(max_length=30, default=None, blank=True, null=True, help_text="ФИО Пациента")
    direction = models.CharField(max_length=255, default=None, blank=True, null=True, help_text="Номер истории")
