...
def send_has_result(self, feed_unique_id: str):
    ...
    individual = feed.individual
    individual_auth = IndividualAuth.objects.filter(individual=individual, is_confirmed=True, last_activity__gte=timezone.now() - timedelta(days=100))
