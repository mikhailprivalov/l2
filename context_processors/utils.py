...
def menu(request):
    ...
    if request.user.is_authenticated and not request.is_ajax():
        ...
        pages = [
            ...
            {"url": "/results/enter", "title": "Лабораторные результаты", "nt": False, "access": ["Врач-лаборант", "Лаборант", "Сброс подтверждений результатов"]},
            {"url": "/laboratory/results", "title": "NG Ввод результатов", "nt": False, "access": []},
            {
