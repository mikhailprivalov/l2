...
class Medicament(models.Model):
    ...
    """
    number_registration = models.CharField(max_length=511, unique=True, help_text='Номер регистрационного удостверения',db_index=True)
    ...
    trade_name = models.CharField(max_length=511, unique=True, help_text='Торговое наименвоание',db_index=True)
