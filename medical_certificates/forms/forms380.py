...
def form_14(request_data):
    ...
    fwb = content_medical(fwb, meta_data, result_lab_from_proto, result_protocol, date_protocol, styles, 'врачом-психиатром')
...
def form_15(request_data):
    ...
    fwb = content_medical(fwb, meta_data, result_lab_from_proto, result_protocol, date_protocol, styles, 'врачом-психиатром-наркологом')
