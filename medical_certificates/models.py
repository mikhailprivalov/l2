...
class MedicalCertificates(models.Model):
    ...
    CERTIFICATE_FORMS = (
        ...
        (38014, '38014. Вождение-психиатр'),
        (38015, '38015. Вождение-нарколог'),
        (38016, '38016. Охранник-психиатр'),
        (38017, '38017. Охранник-нарколог'),
        (38018, '38018. Оружие-психиатр'),
        (38019, '38019. Оружие-нарколог'),
        (38020, '38020. Отсутствие веществ-психиатр'),
        (38021, '38021. Отсутствие веществ-нарколог'),
        (38022, '38022. Отсутствие веществ-заключение'),
    )
