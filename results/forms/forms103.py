...
def add_template(iss: Issledovaniya, direction, offset=0):
    ...
    obj.append(
        FrameData(0, (-32-offset) * mm, 180, 15, text=f'по результатам обследования водителя<br/>транспартнго средства (кандидата в водители траспортного средства)<br/><u>врачом-психиатром</u>',
                  style=styleCenter))
    ...
    text = f'1. Фамилия, имя, отчество (при наличии): {direction.client.individual.fio()}<br/>' \
