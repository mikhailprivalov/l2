...
def form_02(direction, iss, fwb, doc, leftnone, user=None):
    # ПАТОЛОГО-АНАТОМИЧЕСКОЕ заключение
    styleSheet = getSampleStyleSheet()
    style = styleSheet["Normal"]
    style.fontName = "FreeSans"
    ...
    title_fields = [
        ...
        "11.1 Время забора материала по данным направления",
        "12. Материал доставлен в 10%-ный раствор нейтрального формалина",
        "12.1 Загрязнен",
        "13. Дата поступления биопсийного (операционного) материала",
        "13.1 Время поступления биопсийного (операционного) материала",
        "14. Отметка о сохранности упаковки",
        "15. Дата регистрации биопсийного (операционного) материала",
        "15.1 Время регистрации биопсийного (операционного) материала",
        "16. Регистрационный номер",
        "17. Медицинские услуги",
        "18. Категория сложности",
        "19. Дата проведения вырезки",
        "19.1 Время проведения вырезки",
        "20. В проводку взято",
        "21. Назначенные окраски",
        "22. Макроскопическое описание",
        "23. Микроскопическое описание",
        "24. Заключение",
        "25. Код по МКБ",
        "26. Комментарии к заключению и рекомендации",
        "27.1 Прижизненное патолого-анатомическое исследование выполнили: Врач-специалист, осуществляющий консультирование",
    ]
