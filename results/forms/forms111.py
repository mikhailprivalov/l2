...
def form_01(direction: Napravleniya, iss: Issledovaniya, fwb, doc, leftnone, user=None):
    ...
    objs.append(
        Paragraph(
            "16.2.6. Медицинская реабилитация и (или) санаторно-курортное лечение назначены: да, нет (нуж-ное подчеркнуть); если «да»: в амбулаторных условиях, в условиях дневного стационара, в стационарных условиях (нужное подчеркнуть).",
            style,
        )
    )
    objs.append(
    ...
    objs.append(
        Paragraph(
            "16.3.6. Медицинская реабилитация и (или) санаторно-курортное лечение назначены: да, нет (нуж-ное подчеркнуть); если «да»: в амбулаторных условиях, в условиях дневного стационара, в стационарных условиях (нужное подчеркнуть).",
            style,
        )
    )
    objs.append(
    ...
    objs.append(
        Paragraph(
            "16.4.6. Медицинская реабилитация и (или) санаторно-курортное лечение назначены: да, нет (нуж-ное подчеркнуть); если «да»: в амбулаторных условиях, в условиях дневного стационара, в стационарных условиях (нужное подчеркнуть).",
            style,
        )
    )
    objs.append(
    ...
    objs.append(
        Paragraph(
            "16.5.6. Медицинская реабилитация и (или) санаторно-курортное лечение назначены: да, нет (нуж-ное подчеркнуть); если «да»: в амбулаторных условиях, в условиях дневного стационара, в стационарных условиях (нужное подчеркнуть).",
            style,
        )
    )
    objs.append(
    ...
    objs.append(
        Paragraph(
            "16.6.6. Медицинская реабилитация и (или) санаторно-курортное лечение назначены: да, нет (нуж-ное подчеркнуть); если «да»: в амбулаторных условиях, в условиях дневного стационара, в стационарных условиях (нужное подчеркнуть).",
            style,
        )
    )
    objs.append(
