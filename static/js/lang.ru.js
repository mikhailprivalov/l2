...
var fraction_types = {"-1": ["Без вариантов"], "0": ["Отрицательный", "Положительный"], "1": ["Отрицательный", "Положительный", "Сомнительный"], "2": ["Отрицательный", "Положительный", "Неопределенный"], "3": ["Rh (+) положительный", "rh (-) отрицательный", "Rh (+-) слабополож-ый"]};