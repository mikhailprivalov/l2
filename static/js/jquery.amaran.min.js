(function () {
    !function (t, i) {
        ...
        return n = function (i) {
            ...
            init: function () {
                var i, n, o, a, s, c, h, r;
                h = null, r = null, o = this.config.position.split(" "), t(this.config.wrapper).length && t(this.config.wrapper).hasClass(this.config.position) ? (h = t(this.config.wrapper + "." + o[0] + "." + o[1]), s = h.find(".amaran-wrapper-inner")) : (h = t("<div>", {"class": this.config.wrapper.substr(1, this.config.wrapper.length) + " " + this.config.position}).appendTo("body"), s = t("<div>", {"class": "amaran-wrapper-inner"}).appendTo(h)), "object" == typeof this.config.content ? c = null != this.config.themeTemplate ? this.config.themeTemplate(this.config.content) : e[this.config.theme.split(" ")[0] + "Theme"](this.config.content) : (this.config.content = {}, this.config.content.message = this.config.message, this.config.content.color = "#27ae60", c = e.defaultTheme(this.config.content)), i = {
                ...
                var n, e, o;
                e = i.find(".amaran").length, o = i.height(), n = (t.height() - o) / 2, i.find(".amaran:first-child").animate({"margin-top": n}, 200)
                ...
                }), void t.animate({opacity: 0}, function () {
                    t.animate({height: 0}, function () {
                        n.removeIt(t)
                    })
                })) : (t.css({"min-height": 0, height: t.outerHeight()}), void t.animate({opacity: 0}, function () {
                    t.animate({height: 0}, function () {
                        n.removeIt(t)
                    })
                }))
                ...
                return o = this.getInfo(n), a = this.config.position.split(" ")[1], s = {
                    ...
                    slideLeft: {
                        start: {left: "left" === a ? 1.5 * -o.w : -t(i).width()},
                        move: {left: 0},
                        hide: {left: "left" === a ? 1.5 * -o.w : -t(i).width()},
                        height: o.h
                    },
                    slideRight: {
                        start: {left: "right" === a ? 1.5 * o.w : t(i).width()},
                        move: {left: 0},
                        hide: {left: "right" === a ? 1.5 * o.w : t(i).width()},
                        height: o.h
                    }
                }, s[e] ? s[e] : 0
