...
class FormsList(models.Model):
    title = models.DecimalField(max_digits=5, decimal_places=2, unique=True, help_text='Номер формы (3 знака целого числа-это группа, остальные- номер формы В ГРУППЕ)', db_index=True)
