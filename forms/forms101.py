...
def form_10(request_data):
    ...
    objs.append(
        Paragraph(
            '1. Дата начала профилактического медицинского осмотра (диспансеризации) "___"___________ 20__ г. ', style,
        )
    )
    ...
    objs.append(
        Paragraph(
            '3. Пол: <u>{}</u> '.format(patient_data['sex']), style,
        )
    )

    objs.append(
        Paragraph(
            '4. Дата рождения  <u>{}</u> '.format(date_individual_born), style,
        )
    )

    objs.append(
        Paragraph(
            '5. Местность: городская - 1, сельская - 2 ', style,
        )
    )

    objs.append(
        Paragraph(
            '6. Адрес регистрации по месту жительства {}'.format(person_data['fact_address']), style,
        )
    )

    objs.append(
        Paragraph(
            '7. Код категории льготы: _____________', style,
        )
    )

    objs.append(
        Paragraph(
            '8. Принадлежность к коренным малочисленным народам Севера, Сибири и Дальнего Востока Российской Федерации:да - 1; нет - 2', style,
        )
    )

    objs.append(
        Paragraph(
            '9. Занятость: 1 - работает; 2 - не работает; 3 - обучающийся в образовательной организации по очной форме', style,
        )
    )

    objs.append(
        Paragraph(
            '10. Профилактический медицинский осмотр (первый этап диспансеризации) проводится мобильной медицинской бригадой: да - 1; нет – 2', style,
        )
    )
    ...
    opinion = [
        ...
        [
            ...
            Paragraph('<font size=9 >относительный сердечно-сосудистый риск (от 18 лет до 39 лет) _____ %<br/>абсолютный сердечно-сосудистый '
            'риск (от 40 лет до 64 лет включительно) _____ %</font>', styleSign),
        ],
    ]
    ...
    objs.append(
        Paragraph(
            '15. Дата окончания профилактического медицинского осмотра __________________', style,
        )
    )

    objs.append(
        Paragraph(
            'Дата окончания первого этапа диспансеризации _________________', style,
        )
    )

    objs.append(
        Paragraph(
            'Дата окончания второго этапа диспансеризации _________________', style,
        )
    )

    objs.append(
        Paragraph(
            '16. Профилактический медицинский осмотр (диспансеризация) проведен(а): в полном объеме - 1, в неполном объеме - 2', style,
        )
    )
    ...
    objs.append(
        Paragraph(
            '17.1. Все факторы риска, указанные в строках 03, 04, 07, 08, 09 настоящей таблицы: отсутствуют - 1,присутствуют - 2', style,
        )
    )
    ...
    objs.append(
        Paragraph(
            '19. Диспансерное наблюдение установлено:', style,
        )
    )
    objs.append(
        Paragraph(
            '19.1. врачом (фельдшером) отделения (кабинета) медицинской профилактики или центра здоровья: да - 1; нет - 2.', style,
        )
    )
    objs.append(
        Paragraph(
            'Если "да", N строки таблицы пункта 18 ________________', style,
        )
    )
    objs.append(
        Paragraph(
            '19.2. врачом-терапевтом: да - 1; нет - 2. Если "да", N строки таблицы пункта 18 _______________________', style,
        )
    )    
    objs.append(
        Paragraph(
            '19.3. врачом-специалистом: да - 1; нет - 2. Если "да", N строки таблицы пункта 18 _____________________', style,
        )
    )    
    objs.append(
        Paragraph(
    ...
    objs.append(
        Paragraph(
            '20. Группа  здоровья:  I группа - 1,   II группа - 2,   IIIа  группа - 3,   IIIб группа - 4', style,
        )
    )    
    objs.append(
        Paragraph(
    ...
    objs.append(
        Paragraph(
            'Если "да", дата направления "___"___________ 20__ г', style,
        )
    )    
    objs.append(
        Paragraph(
            '23. Направлен для получения специализированной, в том числе высокотехнологичной, медицинской помощи: да - 1; нет - 2', style,
        )
    )
    objs.append(
        Paragraph(
    ...
    objs.append(
        Paragraph(
            '24. Направлен на санаторно-курортное лечение: да - 1; нет - 2', style,
        )
    )
    ...
    objs.append(
        Paragraph(
            ...
            '<font size=9 >Российской Федерации 2 сентября 2019 г. N 716н (зарегистрирован Министерством юстиции Российской Федерации 16 октября 2019 г., регистрационный N 56254).</font>', style,
        )
    )
