...
def form_03(request_data):
    """
     ...
     --------------------------------------------------------------------------------------------------------------
     Приказ Министерства здравоохранения РФ от 12 ноября 2021 г. N 1177н
    ...
    objs = [
        Paragraph(
            'Приложение №2<br/>  к приказу Министерства здравоохранения <br/> Российской Федерации<br/>  от 12 ноября 2021г.№ 1051н', styleT,
        ),
    ]
...
def form_11(request_data):
    ...
    objs.append(Paragraph('_________________________________________________________________________________________________', styleSign))
    objs.append(Paragraph('(указываются возможные последствия отказа от вышеуказанного(вышеуказанных) вида (видов) медицинского', styleCenter))
    objs.append(Paragraph(' вмешательства, в том числе вероятность развития осложнений заболевания (состояния))', styleCenter))
    objs.append(Paragraph('_________________________________________________________________________________________________', styleSign))
    objs.append(Paragraph('_________________________________________________________________________________________________', styleSign))
