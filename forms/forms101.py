...
def form_18(request_data):
    ...
    objs.append(Paragraph(f'- Мне согласно моей воли даны полные и всесторонние разъяснения о характере, степени тяжести и возможных осложнениях {patient_status_pronoun_genitive_case} '
                          'заболевания', style))
    ...
    objs.append(Paragraph('4. Лабораторные методы исследования (химико-микроскопические, гематологические, цитологические, биохимические, коагулотические, иммунологические, '
    ...
    objs.append(Paragraph('- Я информирован(а) о целях, характере и неблагоприятных эффектах диагностических и лечебных процедур, возможности непреднамеренного причинения вреда здоровью, а '
                          f'также о том, что предстоит {patient_status} делать во время их проведения;', style))
    objs.append(Paragraph(f'- Я извещен(а) о том, что {patient_status} необходимо регулярно принимать назначенные препараты и другие методы лечения, немедленно сообщать врачу о любом '
                          'ухудшении самочувствия, согласовывать с врачом прием любых, не прописанных лекарств;', style))
    objs.append(Paragraph('- Я предупрежден(на) и осознаю, что отказ от лечения, несоблюдение <b>лечебно-охранительного режима</b>, рекомендаций медицинских работников, режима приема '
                          ...
                          'сказаться на состоянии здоровья;', style))
    objs.append(Paragraph('- Я поставил(а) в известность врача обо всех проблемах, связанных со здоровьем, в том числе об аллергических проявлениях или индивидуальной непереносимости '
                          ...
                          f'лекарственных средствах. Я сообщил(а) правдивые сведения о наследственности, а также об употреблении алкоголя, наркотических и токсических средств;', style))
    objs.append(Spacer(1, space))
    objs.append(Paragraph(f'Я <u>{person_data["fio"]}</u>', style))
    objs.append(Spacer(1, space))
    objs.append(Paragraph('согласен(на) на осмотр другими медицинскими работниками и студентами медицинских вузов и колледжей исключительно в медицинских, научных или обучающих целях с '
                          'учетом сохранения врачебной тайны;', style))
    objs.append(Spacer(1, space))
    objs.append(Paragraph(f'Я <u>{person_data["fio"]}</u>', style))
    objs.append(Spacer(1, space))
    objs.append(Paragraph('ознакомлен(а) и согласен(на) со всеми пунктами настоящего документа, положения которого мне разъяснены, мною поняты, и добровольно даю свое согласие на '
                          f'обследование и лечение {patient_status_genitive_case} в предложенном объеме; ', style))
    objs.append(Paragraph('- Разрешаю, в случае необходимости, предоставить информацию о диагнозе, степени тяжести и характере заболевания моим родственникам, законным представителям,',
                          style))
    objs.append(Spacer(1, space))
