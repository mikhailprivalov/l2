...
def form_08(request_data):
    """
    Инфорованное добровольное согласие на виды
    ...
    opinion = [
        [
            Paragraph('', style),
            Paragraph('Приложение №2 к приказу Министерства здравоохранения <br/> Российской Федерации от 20 декабря 2012г.№ 117н', styleT),
        ],
    ]
    ...
    objs.append(
        Paragraph(
            'СОГЛАСИЕ <br/> Инфорованное добровольное согласие на виды <br/> медицинских вмешательств, включенные в Перечень определенных <br/> видов медицинских вмешательств,'
            'на которые граждане дают <br/> информированное добровольное согласие при выборе врача <br/> И медицинской организации для получения первичной <br/> медико-санитарной'
    ...
    objs.append(
        Paragraph(
            ...
            'от 23 апреля 2012 г. N 390н (зарегистрирован Министерством юстиции Российской '
            'Федерации 5 мая 2012 г. N 24082) (далее – Перечень), для получения первичной '
            'получения первичной медико-санитарной помощи / первичной медико-санитарной помощи '
