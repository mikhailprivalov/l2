...
def form_18(request_data):
    ...
    objs.append(Paragraph('1. Опрос, субъективное обследование (жалобы, анамнез)', style))
    objs.append(Paragraph('2. Осмотр, в том числе объективное обследование (пальпация, перкуссия, аускультация, определение ЧСС, ЧДД, антропометрия, термометрия, пульсометрия)', style))
    objs.append(Paragraph('3. Осмотр узкими специалистами (включая неинвазивные методы диагностики)', style))
    objs.append(
        Paragraph(
            '4. Лабораторные методы исследования (химико-микроскопические, гематологические, цитологические, биохимические, коагулотические, иммунологические, '
            'микробиологические, молекулярно-генетические, микробиологические, химико-токсикологические), в том числе в сторонних организациях на основе заключенных '
            'договоров.',
            style,
        )
    )
    objs.append(Paragraph('5. Функциональные методы исследования.', style))
    objs.append(Paragraph('6. Физиотерапевтическое лечение (в том числе медицинский массаж и лечебная физкультура).', style))
    objs.append(Paragraph('7. Введение лекарственных препаратов (внутрь, наружно, ингаляционно, парентерально)', style))
    ...
    objs.append(
        Paragraph(
            ...
            f'также о том, что предстоит {patient_status} делать во время их проведения;',
            style,
        )
    )
    objs.append(
        Paragraph(
            f'- Я извещен(а) о том, что {patient_status} необходимо регулярно принимать назначенные препараты и другие методы лечения, немедленно сообщать врачу о любом '
            'ухудшении самочувствия, согласовывать с врачом прием любых, не прописанных лекарств;',
            style,
        )
    )
    objs.append(
        Paragraph(
            '- Я предупрежден(на) и осознаю, что отказ от лечения, несоблюдение <b>лечебно-охранительного режима</b>, рекомендаций медицинских работников, режима приема '
            'препаратов, самовольное использование медицинского инструментария и оборудования, бесконтрольное самолечение могут осложнить процесс лечения и отрицательно '
    ...
    objs.append(
        Paragraph(
            ...
            'лекарственных препаратов, обо всех перенесенных мною (представляемым) и известных мне травмах, операциях, заболеваниях, об экологических и производственных '
            f'факторах физической, химической или биологической природы, воздействующих на {patient_status_genitive_case} во время жизнедеятельности, о принимаемых '
            f'лекарственных средствах. Я сообщил(а) правдивые сведения о наследственности, а также об употреблении алкоголя, наркотических и токсических средств;',
            style,
        )
    )
    objs.append(Spacer(1, space))
    objs.append(Paragraph(f'Я <u>{person_data["fio"]}</u>', style))
    objs.append(Spacer(1, space))
    objs.append(
        Paragraph(
            'согласен(на) на осмотр другими медицинскими работниками и студентами медицинских вузов и колледжей исключительно в медицинских, научных или обучающих целях с '
    ...
    objs.append(
        Paragraph('- Разрешаю, в случае необходимости, предоставить информацию о диагнозе, степени тяжести и характере заболевания моим родственникам, законным представителям,', style)
    )
    objs.append(Spacer(1, space))
    objs.append(Paragraph('Гражданам:', style))
    objs.append(Spacer(1, 2 * space))
    objs.append(HRFlowable(width=190 * mm, color=colors.black))
...
def form_20(request_data):
    ...
    objs.append(Paragraph('на основании статьи 20 Федерального закона №323-ФЗ от 21.11.2011г. «Об основах охраны здоровья граждан в РФ», даю информированное добровольное согласие на '
                          'проведение компьютерной томографии:', style))
    objs.append(Paragraph('1. Я в полной мере проинформирован(а) о порядке проведения и содержании всех необходимых диагностических мероприятий, о том, что метод является '
                          'рентгенологическим и связан с облучением.', style))
    objs.append(Paragraph('2. Я в полной мере проинформирован(а) о характере предстоящих исследований, связанном с ними риском и возможном развитии неприятных ощущений, осложнений и '
                          'последствий: 1) аллергических реакциях при введении контрастного вещества; 2) возможной клаустрофобии.', style))
    objs.append(Paragraph('3. Я проинформирован(а) о строгих противопоказаниях к исследованию с контрастным усилением: наличие аллергической реакция на йод, йодсодержащие и др. препараты. ',
                          style))
    ...
    objs.append(Paragraph('5. Мне разъяснено, что в ходе выполнения исследования, может возникнуть необходимость расширения объема диагностических мероприятий. Я доверяю врачам '
                          f'{hospital_name} выполнять все необходимые действия, которые врач-рентгенолог сочтет необходимым для проведения исследования.', style))
    objs.append(Paragraph('6. Я предоставил(а) врачу-рентгенологу все известные мне данные о состоянии своего (или лица, законным представителем которого я являюсь) здоровья, а также всю '
                          ...
                          'информацию в медицинской документации.', style))
    objs.append(Paragraph('7. Я согласен(а) на возможное введение контрастного препарата и отрицаю наличие у себя следующих заболеваний: бронхиальная астма; тяжелые заболевания печени '
                          ...
                          'препараты.', style))
    objs.append(Paragraph('8. Я имел(а) возможность задать все интересующие меня вопросы. Мне даны исчерпывающие ответы на все заданные мной вопросы. Я ознакомлен(а) и согласен(а) со всеми '
                          'пунктами настоящего документа.', style))
    objs.append(Spacer(1, space))
...
def form_21(request_data):
    ...
    objs.append(Paragraph('Подтверждаю, что я ознакомлен (ознакомлена) с характером, особенностями и ходом предстоящего мне (представляемому мной лицу) эндоскопического вмешательства',
                          style))
    objs.append(Paragraph('Мне разъяснено, и я осознаю, что во время операции могут возникнуть непредвиденные обстоятельства и осложнения. В таком случае я согласен (согласна) на то, что '
                          'ход операции может быть изменен врачами по их усмотрению. ', style))
    objs.append(Paragraph('Я предупрежден (предупреждена) и понимаю, что проведение эндоскопического вмешательства сопряжено с рисками непреднамеренного причинения вреда здоровью и даже '
                          ...
                          'патологии, в т.ч. сердечно-сосудистых заболеваний.</b> ', style))
    ...
    objs.append(Paragraph('Я признаю право врача прерывать исследование в случае, если в ходе исследования будет выявлена невозможность продолжения исследования по физиологическим или '
                          ...
                          'зависящих от воли врача и пациента обстоятельств. ', style))
    objs.append(Paragraph('Я поставил (поставила) в известность врача обо всех проблемах, связанных со здоровьем, в том числе об аллергических проявлениях или индивидуальной '
                          ...
                          'крови и ее компонентов. ', style))
    objs.append(Paragraph('Сообщил (сообщила) правдивые сведения о наследственности, а также об употреблении алкоголя, наркотических и токсических средств. Я признаю свою ответственность в '
                          ...
                          'демонстрацию лицам с медицинским образованием исключительно в медицинских, научных или обучающих целях с учетом сохранения врачебной тайны. ', style))
    objs.append(Paragraph('Мне была предоставлена возможность задать все интересующие меня вопросы о степени риска и пользе оперативного вмешательства, и врач дал понятные мне '
                          'исчерпывающие ответы. ', style))
    objs.append(Paragraph('Я согласен (согласна) добросовестно сотрудничать с лечащим врачом по вопросам, связанным с оказанием мне медицинской помощи, выполнять рекомендации и немедленно '
                          'сообщать ему о любого рода изменениях моего самочувствия. ', style))
    objs.append(Paragraph('Я ознакомлен (ознакомлена) и согласен (согласна) со всеми пунктами настоящего документа, положения которого мне разъяснены, мною поняты и добровольно даю свое '
