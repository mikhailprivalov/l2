...
def form_02(request_data):
    """
    Отдельный статталон по отдельному амбулаторному приему. Входные направление.
    Краткая форма - результата проткоола. Учитываются те поля, к-рые имеют признак "для статталона"
    Выходные: форма
    """
